...
def input(in_msg, timeslot=None):
    ...
    if in_msg.settings == "manual":
        ...
        if check_overwriting > 1:
            print("ERROR, you are overwriting your settings!!!! Check: ", current_setting)
            quit()
    ...
    # in case that in_msg.settings != "manual":
    else:
    ...
    in_msg.channels15 = ['WV_062']   # !!! CHANGE BACK
    in_msg.channels30 = []           # !!! CHANGE BACK
